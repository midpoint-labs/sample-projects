...
contract TestMidpointStorageContract {
    ...
    event RequestMade(uint256 input);
    event ResponseReceived(uint64 Request_ID, uint64 Midpoint_ID, uint256[] outputs);
    ...
    // This can be removed without impacting the functionality of your midpoint
    mapping(uint64 => uint256[]) public request_id_to_outputs;
   ...
   function callback(uint64 Request_ID, uint64 Midpoint_ID, uint256[] memory outputs) public {
